    ...
    <div class="row" style="display: inline-block;">
        <div class="tile_count">
            <div class="col-md-4 col-sm-4  tile_stats_count">
                <span class="count_top"><i class="fa fa-user"></i> Aktif Ziyaretçi</span>
                <div class="count green">25</div>
            </div>
            <div class="col-md-4 col-sm-4  tile_stats_count">
                <span class="count_top"><i class="fa fa-clock-o"></i> Ortalama Aktif Ziyaretçi</span>
                <div class="count">12,5</div>
                <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>3% </i> From last Week</span>
            </div>
            <div class="col-md-4 col-sm-4  tile_stats_count">
                <span class="count_top"><i class="fa fa-user"></i> Aylık Ziyaretçi Toplamı</span>
                <div class="count">2.387</div>
                <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>34% </i>Geçen aya göre</span>
            </div>
        </div>
    </div>
    <!-- /top tiles -->
