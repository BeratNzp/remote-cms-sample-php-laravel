                        ...
                        <table id="datatable-responsive"
                            ...
                            @foreach($companies as $company)
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-primary btn-sm" onclick="details({{ $company->id }});">
                                            Düzenle
                                        </button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body"> <!-- Modal Content -->
                    <form id="editItemForm"
                          method="POST"
                          action="{{ route("company.edit_action") }}"
...
@section('page_scripts')
    <script type="text/javascript">
        function runDeleteModal(company_id, title) {
            ...
            $('#deleteItemAction').attr('onclick', 'deleteCompany(' + company_id + ');');
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $.each(data.departments, function (key, value) {
                            $("#department_id").append($("<option></option>").attr("value", value['id']).text(value['title']));
                        });
                    },
                });
            }
