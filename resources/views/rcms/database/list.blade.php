        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="migrateItemAction" class="btn btn-primary">Sıfırla & Güncelle</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body"> <!-- Modal Content -->
                    <form id="editItemForm"
                        ...
                        <div class="item form-group">
                            <label for="ip"
                                   class="col-form-label col-md-3 col-sm-3 label-align">IP</label>
                            <div class="col-md-6 col-sm-12">
                                <input type="text" class="form-control has-feedback-left" name="ip"
                                       id="ip" onchange="checkConnection();">
                        ...
                        <div class="item form-group">
                            <div class="col-md-6 col-sm-6 offset-md-3">
                                <button type="button" id="migrate_button" class="btn btn-primary">Sıfırla & Güncelle
                                </button>
    ...
    <script type="text/javascript">
        function checkConnection() {
            ...
            $.ajax({
                ...
                beforeSend: function () {
                    $('#check_connection').html("Bağlantı testi yapılıyor... Lütfen bekleyin");
                },
        ...
        function detail(id) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#editItemForm #ip').val(data.database.ip);
